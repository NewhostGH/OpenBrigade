...
- [ ] Port Prélèvements and Virements tabs from `cotisations.php` (tab 2/3): direct-debit batch generation (`cotisations_extract.php`, CFONB format) and bank-transfer list — bank-account feature, permission 53 (commit: ...)
