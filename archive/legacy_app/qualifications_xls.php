...
$letters = [];
if ($grades == 1 and $nbsections == 0) {
    $l = 'F';
} elseif ($grades == 1 or $nbsections == 0) {
    $l = 'E';
} else {
    $l = 'D';
}
...
if ($filter > 0 or $subsections == 0 and $role > 0) {
    $queryX .= ' union '.$query1.$queryfilter2;
}
$queryX .= $queryorder;
