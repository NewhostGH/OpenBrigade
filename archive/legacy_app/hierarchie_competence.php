...
if ($number > 0) {
    ...
    while (custom_fetch_array($result1)) {
        ...
        if ($PH_HIDE_LOWER == 1) {
            $hide = "<div class='fa fa-check fa-lg' title=$t1></div>";
        } else {
            $hide = '';
        }

        if ($PH_UPDATE_LOWER_EXPIRY == 1) {
            $update = "<i class='fa fa-check fa-lg' title=$t2></i>";
        } else {
            $update = '';
        }

        if ($PH_UPDATE_MANDATORY == 1) {
            $mandatory = "<i class='fa fa-check fa-lg' title=$t3></i>";
        } else {
            $mandatory = '';
        }
