...
if ($tab == 6) {
    forceReloadJS('js/search_habilitation.js');
} else {
    forceReloadJS('js/search_personnel.js');
}
echo '</head>';
echo '<body>';
if ($syndicate == 1) {
    $t = 'Recherche dans la base des adhérents';
} else {
    $t = 'Recherche de personnel';
}
