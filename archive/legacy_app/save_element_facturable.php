...
if (isset($_GET['EF_NAME'])) {
    $EF_NAME = secure_input($dbc, str_replace('"', '', $_GET['EF_NAME']));
} else {
    $EF_NAME = '';
}
if (isset($_GET['EF_PRICE'])) {
    $EF_PRICE = (float) $_GET['EF_PRICE'];
} else {
    $EF_PRICE = 0;
}
if (isset($_GET['TEF_CODE'])) {
    $TEF_CODE = $_GET['TEF_CODE'];
} else {
    $TEF_CODE = '';
}
