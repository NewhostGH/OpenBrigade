...
if (isset($_POST['save'])) {
    if ($err > 0) {
        if ($err == 2) {
            $msg = "Erreur le paramètre <b>serveur</b> n'est pas renseigné.</b>";
        } elseif ($err == 3) {
            $msg = "Erreur le paramètre <b>database</b> n'est pas renseigné.</b>";
        } elseif ($err == 4) {
            $msg = "Erreur le paramètre <b>user</b> n'est pas renseigné.</b>";
        } else {
            $msg = 'Erreur de connection à la base de données avec les paramètres choisis:<p><b>'.$errmsg.'</b>';
        }
