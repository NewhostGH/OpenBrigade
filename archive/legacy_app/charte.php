...
echo import_jquery();
echo import_bootstrap_js_bundle();
...
if ($nbsections == 0 and $syndicate == 1) {
    ...
    $A = "du centre d'incendie et de secours";
}

if ($application_title != 'eBrigade') {
    $site = $application_title;
} else {
    $site = '<b>'.str_replace('www.', '', $cisurl).'</b>';
}
...
if ($disponibilites) {
    $charte .= ' <li>saisir ses disponibilités ou indisponibilités mensuelles,</li>';
}
if ($nbsections > 0) {
    $charte .= '<li>consulter le tableau de gardes mensuelles,</li>';
}
if ($syndicate == 0) {
    $charte .= '<li>visualiser ses compétences opérationnelles,</li>';
}
