...
if ($renfort == 0) {
    ...
    $errcode = 1;
} elseif (get_nb_sessions($evenement) > 1) {
...
//    $errcode=1;
// }
elseif (! evenements_overlap($evenement, $renfort)) {
