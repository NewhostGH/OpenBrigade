...
if (! is_dir('./images/evenements/iconespersos')) {
    mkdir('./images/evenements/iconespersos', 0755, true);
}
...
if ($TE_CODE == '') {
    $current = 'images/evenements/WHAT.png';
}
...
if ($TE_VICTIMES == 1 and $TE_MAIN_COURANTE == 1) {
    $checked = 'checked';
} else {
    $checked = '';
}
...
$list = ['', 'VICTIMES', 'INTERVENTIONS', 'VI_INFORMATION', 'VI_REFUS', 'VI_IMPLIQUE', 'VI_MALAISE', 'VI_SOINS', 'VI_MEDICALISE',
...
$list2 = ['VI_TRANSPORT', 'TRANSPORT_AUTRE', 'TRANSPORT_ASS'];
