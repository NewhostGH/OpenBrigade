...
<?php
if (isset($_POST['CC_CODE_PREV'])) {
    $cat_old = secure_input($dbc, $_POST['CC_CODE_PREV']);
} else {
    $cat_old = '';
}
if (isset($_POST['CC_CODE'])) {
    $cat_code = secure_input($dbc, $_POST['CC_CODE']);
} else {
    $cat_code = '';
}
if (isset($_POST['CC_NAME'])) {
    $cat_name = secure_input($dbc, $_POST['CC_NAME']);
} else {
    $cat_name = '';
}
if (isset($_POST['logo'])) {
    $logo = secure_input($dbc, $_POST['logo']);
} else {
    $cat_name = '';
}
if (isset($_POST['CC_DESCRIPTION'])) {
    $description = secure_input($dbc, $_POST['CC_DESCRIPTION']);
} else {
    $description = '';
}
if (isset($_POST['Delete'])) {
    $del = secure_input($dbc, $_POST['Delete']);
} else {
    $del = '';
}
