...
{
    // Propriétés privées
    public $_Avery_Name = '';                // Nom du format de l'étiquette

    public $_Margin_Left = 0;                // Marge de gauche de l'étiquette

    public $_Margin_Top = 0;                // marge en haut de la page avant la première étiquette

    public $_X_Space = 0;                // Espace horizontal entre 2 bandes d'étiquettes

    public $_Y_Space = 0;                // Espace vertical entre 2 bandes d'étiquettes

    public $_X_Number = 0;                // Nombre d'étiquettes sur la largeur de la page

    public $_Y_Number = 0;                // Nombre d'étiquettes sur la hauteur de la page

    public $_Width = 0;                // Largeur de chaque étiquette

    public $_Height = 0;                // Hauteur de chaque étiquette

    public $_Char_Size = 10;                // Hauteur des caractères

    public $_Line_Height = 10;                // Hauteur par défaut d'une ligne
