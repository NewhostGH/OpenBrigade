...
if ($TR_CONFIG == 1) {
    ...
    $title = "Rôle de l'organigramme";
} else {
    $title = "Permission de l'organigramme";
}
...
if ($GP_ID >= 100) {
    $tt = "Si l'ordre choisi est 100, alors le rôle n'apparaît pas dans l'organigramme imprimable avec photos";
} else {
    $tt = "Choisir l'ordre d'affichage dans le tableau";
}
...
echo '<tr>
            ...
            <td align=left colspan=2>';
echo write_modal('membres.php?groupe='.$GP_ID, 'liste', "<span class='badge' style='background-color:purple;' title='cliquer pour voir la liste du personnel'>$NB</span>");
echo '</tr>';
