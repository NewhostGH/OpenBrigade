...
$styleFont->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_DARKBLUE);
    ...
    while ($row=@mysqli_fetch_array($result)) {
        ...
        if ( $P_ID <> $prevpid) {
            ...
            if ( $AGE > 0 and $AGE < 18 ) {
                ...
                $styleFontM->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_RED);
            }
            $prevpid=$P_ID;
        }
        else $NewPID=false;
