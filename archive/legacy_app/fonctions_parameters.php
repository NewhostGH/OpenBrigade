...
function get_session_parameters()
{
    ...
    $old, $mad, $type_materiel, $position, $typequalif, $type_evenement, $sectionorder, $canceled,
    $dtdb, $dtfn, $td, $vehicule, $matos, $catmessage, $catmateriel, $catGrade, $lccode, $lcid, $ltcode,
    ...
    $type_victime, $in_cav, $a_reguler, $sectioninscription, $sectionresponsable, $horaires_tableau_garde, $type_event, $competence, $status, $autorefresh,
    $show_section, $birthdate, $birthplace, $firstname, $show_indispos, $show_spp, $nationality, $horaire_list_mode, $display_order,
    $action_comp,$expand, $day_planning, $old_included, $custom_subsections, $equipe;
    global $chxCal;
    global $dbc, $grades;
    ...
    if (isset($_SESSION['SES_FAVORITE'])) {
        $favoritesection = $_SESSION['SES_FAVORITE'];
    } else {
        $favoritesection = $mysection;
    }
    ...
    } elseif (isset($_SESSION['day_planning'])) {
    ...
    } elseif (isset($_SESSION['show_indispos'])) {
    ...
    } elseif (isset($_SESSION['display_order'])) {
    ...
    } elseif (isset($_SESSION['action_comp'])) {
    ...
    } elseif (isset($_SESSION['show_spp'])) {
    ...
    } elseif (isset($_SESSION['horaire_list_mode'])) {
    ...
    } elseif (isset($_SESSION['show_section'])) {
    ...
    } elseif (isset($_SESSION['birthplace'])) {
    ...
    } elseif (isset($_SESSION['nationality'])) {
    ...
    } elseif (isset($_SESSION['tableau_garde_display_mode'])) {
    ...
    } elseif (isset($_SESSION['horaires_tableau_garde'])) {
    ...
    } elseif (isset($_SESSION['autorefresh'])) {
    ...
    } elseif (isset($_SESSION['sectioninscription'])) {
        $sectioninscription = $_SESSION['sectioninscription'];
    } else {
        if ($mysection > 0) {
            $sectioninscription = $mysection;
        } else {
            $sectioninscription = '-1';
        }
    }

    // sectionresponsable pour upd_responsable
    if (isset($_GET['sectionresponsable'])) {
        $sectionresponsable = intval($_GET['sectionresponsable']);
        $_SESSION['sectionresponsable'] = $sectionresponsable;
    } elseif (isset($_SESSION['sectionresponsable'])) {
        $sectionresponsable = $_SESSION['sectionresponsable'];
    } else {
        if ($mysection > 0) {
            $sectionresponsable = $mysection;
        } else {
            $sectionresponsable = '-1';
        }
    }
    ...
    } elseif (isset($_SESSION['evenement_victime'])) {
    ...
    } elseif (isset($_SESSION['type_victime'])) {
    ...
    } elseif (isset($_SESSION['a_reguler'])) {
    ...
    } elseif (isset($_SESSION['evenement_facture'])) {
    ...
    } elseif (isset($_SESSION['evenement_date'])) {
    ...
    } elseif (isset($_SESSION['evenement_periode'])) {
    ...
    } elseif (isset($_SESSION['evenement_show_competences'])) {
    ...
    } elseif (isset($_SESSION['evenement_show_absents'])) {
    ...
    } elseif (isset($_SESSION['stockonly'])) {
    ...
    } elseif (isset($_SESSION['competence'])) {
    ...
    if (isset($_GET['modevictime'])) {
        ...
        $_SESSION['modevictime'] = $modevictime;
    } elseif (isset($_SESSION['modevictime'])) {
    ...
    } elseif (isset($_SESSION['compte_a_debiter'])) {
    ...
    } elseif (isset($_SESSION['type_indispo'])) {
    ...
    } elseif (isset($_SESSION['include_old'])) {
    ...
    } elseif (isset($_SESSION['type_paiement'])) {
    ...
    } elseif (isset($_SESSION['searchdep'])) {
    ...
    } elseif (isset($_SESSION['type_astreinte'])) {
    ...
    // equipe (tableau de garde type de garde)
    if (isset($_GET['equipe'])) {
        $equipe = intval($_GET['equipe']);
        $_SESSION['equipe'] = $equipe;
    } elseif (isset($_SESSION['equipe'])) {
        ...
        if ($gardes == 0) {
            ...
            if ($nbsections > 0) {
                $query_default = 'select count(EQ_ID) from type_garde where EQ_DEFAULT=1';
                $numRows = $dbc->query($query_default)->fetch_row()[0];

                if ($numRows == 0) {
                    $query = 'select min(EQ_ID) from type_garde';
                } else {
                    $query = 'select EQ_ID from type_garde where EQ_DEFAULT=1';
                }
            } else {
                $query_default = 'select count(EQ_ID) from type_garde where EQ_DEFAULT=1 and S_ID='.$filter;
                $numRows = $dbc->query($query_default)->fetch_row()[0];

                if ($numRows == 0) {
                    $query = 'select min(EQ_ID) from type_garde where S_ID='.$filter;
                } else {
                    $query = 'select EQ_ID from type_garde where EQ_DEFAULT=1 and S_ID='.$filter;
                }
            }
    ...
    } elseif (isset($_SESSION['msgfilter'])) {
    ...
    } elseif (isset($_SESSION['subsections'])) {
        $subsections = $_SESSION['subsections'];
    } else {
        if (isset($custom_subsections)) {
            $subsections = intval($custom_subsections);
        } else {
            $subsections = 1;
        }
    }
    ...
    } elseif (isset($_SESSION['sectionorder'])) {
    ...
    } elseif (isset($_SESSION['canceled'])) {
    ...
    } elseif (isset($_SESSION['renforts'])) {
    ...
    } elseif (isset($_SESSION['type_evenement'])) {
    ...
    } elseif (isset($_SESSION['vehicule'])) {
    ...
    } elseif (isset($_SESSION['typecompany'])) {
    ...
    if (isset($_GET['type_materiel'])) {
        $type_materiel = secure_input($dbc, $_GET['type_materiel']);
        $_SESSION['type_materiel'] = $type_materiel;
    } elseif (isset($_SESSION['type_materiel'])) {
        $type_materiel = $_SESSION['type_materiel'];
    } else {
        $type_materiel = 'ALL';
    }
    if ($type_materiel == '') {
    ...
    } elseif (isset($_SESSION['type_conso'])) {
    ...
    } elseif (isset($_SESSION['type_element'])) {
    ...
    } elseif (isset($_SESSION['catmessage'])) {
    ...
    } elseif (isset($_SESSION['catmateriel'])) {
        $catmateriel = $_SESSION['catmateriel'];
    } else {
        $catmateriel = 'ALL';
    }

    // categorie grade, utilisé dans page paramétrage
    if (isset($_GET['catGrade'])) {
        $catGrade = secure_input($dbc, $_GET['catGrade']);
        $_SESSION['catGrade'] = $catGrade;
    } elseif (isset($_SESSION['catGrade'])) {
        $catGrade = $_SESSION['catGrade'];
    } else {
        $catGrade = 'ALL';
    }
    ...
    } elseif (isset($_SESSION['catconso'])) {
    ...
    } elseif (isset($_SESSION['typequalif'])) {
    ...
    } elseif (isset($_SESSION['yearreport'])) {
    ...
    } elseif (isset($_SESSION['type_event'])) {
        $type_event = $_SESSION['type_event'];
    } else {
        $type_event = 'ALL';
    }

    // competence pour report
    if (isset($_GET['competence'])) {
        $competence = secure_input($dbc, $_GET['competence']);
        $_SESSION['competence'] = $competence;
    } elseif (isset($_SESSION['competence'])) {
        $competence = $_SESSION['competence'];
    } else {
    ...
    if (isset($_GET['exp'])) {
        ...
        $_SESSION['exp'] = $exp;
    } elseif (isset($_SESSION['exp'])) {
        $exp = $_SESSION['exp'];
    } else {
        $exp = '';
    }

    // périodes d'interdiction interdire anciennes
    if (isset($_GET['old_included'])) {
        $old_included = intval($_GET['old_included']);
        $_SESSION['old_included'] = $old_included;
    } elseif (isset($_SESSION['old_included'])) {
        $old_included = $_SESSION['old_included'];
    } else {
        $old_included = '0';
    }
}
