...
// Save in GUI mode
// ===================================
elseif (isset($_GET['pid']) or isset($_GET['number'])) {
    if ($nb > 0) {
        ...
        echo " <input type='button' class='btn btn-default' value='Retour' onclick=\"redirect('import_api.php');\">";
    }
}
// ===================================
// Display form
// ===================================
    ...
    $html .= "<p><input type='button' class='btn btn-default left10' value='Importer' name='importer' onclick=\"run_import();\" title=\"Lancer l'import\" $disabled><p>";
}
