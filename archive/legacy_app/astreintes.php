...
$possibleorders = ['AS_DEBUT', 'AS_FIN', 'GP_DESCRIPTION', 'P_NOM', 'S_CODE', 'P_EMAIL', 'P_PHONE'];
...
if ($nb == 0) {
    ...
    if ($number > 0) {
        ...
        while ($row = @mysqli_fetch_array($result)) {
            ...
            $P_EMAIL = $row['P_EMAIL'];
            if ($P_EMAIL != '') {
                $P_EMAIL = '<a href=mailto:'.$P_EMAIL.'>'.$P_EMAIL.'</a>';
            }
            $P_PHONE = $row['P_PHONE'];
            ...
            $num = $row2[0];
            if ($num > 0) {
                $w = "<i class='fa fa-exclamation-triangle' style='color:orange;' title=\"Attention: chevauchement avec $num autre(s) astreinte(s)\"></i>";
            } else {
                $w = '';
            }
            ...
            if ($absences > 0) {
                $z = "<i class='fa fa-exclamation-circle' style='color:red;' title=\"Attention: cette personne a des absences enregistrées pendant cette astreinte\"></i>";
            } else {
                $z = '';
            }
            ...
            if ($P_ID == 0) {
                ...
                echo "<a href='upd_personnel.php?pompier=$P_ID'>$P_PRENOM $P_NOM</a></td>";
            }
