...
if (isset($_POST['heures'])) {
    $heures = (float) (($_POST['heures']));
} else {
    $heures = '0';
}
if (isset($_POST['heures_par_jour'])) {
    $heures_par_jour = (float) (($_POST['heures_par_jour']));
} else {
    $heures_par_jour = '';
}
if (isset($_POST['cp_par_an'])) {
    $cp_par_an = (float) (($_POST['cp_par_an']));
} else {
    $cp_par_an = '0';
}
if (isset($_POST['heures_par_an'])) {
    $heures_par_an = (float) (($_POST['heures_par_an']));
} else {
    $heures_par_an = '0';
}
if (isset($_POST['heures_a_recuperer'])) {
    $heures_a_recuperer = (float) (($_POST['heures_a_recuperer']));
} else {
    $heures_a_recuperer = '0';
}
if (isset($_POST['reliquat_cp'])) {
    $reliquat_cp = (float) (($_POST['reliquat_cp']));
} else {
    $reliquat_cp = '0';
}
if (isset($_POST['reliquat_rtt'])) {
    $reliquat_rtt = (float) (($_POST['reliquat_rtt']));
} else {
    $reliquat_rtt = '0';
}

check_all(2);
if (! check_rights($id, 2, get_section_of("$person"))) {
    check_all(24);
}
