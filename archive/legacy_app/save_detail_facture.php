...
?>
<script>
function redirect(evenement,type) {
    if ( type == 'devis' ) child=1;
    else child=2;
    url = "evenement_display.php?evenement="+evenement+"&tab=17&child="+child+"&table=1";
...
echo "<body onload=\"redirect('".$evenement."','".$type."');\" />";
writefoot();
