...
<?php
if (isset($_POST['TM_USAGE_PREV'])) {
    $cat_old = secure_input($dbc, $_POST['TM_USAGE_PREV']);
} else {
    $cat_old = '';
}
if (isset($_POST['TM_USAGE'])) {
    $cat_value = secure_input($dbc, $_POST['TM_USAGE']);
} else {
    $cat_value = '';
}
if (isset($_POST['CM_DESCRIPTION'])) {
    $cat_description = secure_input($dbc, $_POST['CM_DESCRIPTION']);
} else {
    $cat_description = '';
}
if (isset($_POST['logo'])) {
