...
class vcard
{
    ...
    */
    public function build()
    {
        ...
        */
        ...
        if ($this->data['photo']) {
            $imagetypes = [IMAGETYPE_JPEG => 'JPEG', IMAGETYPE_GIF => 'GIF', IMAGETYPE_PNG => 'PNG', IMAGETYPE_BMP => 'BMP'];
    ...
    */
    public function generateMailMessage()
    {
