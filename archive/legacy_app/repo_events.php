...
if ($assoc == 1) {
    ...
    if ($PSE + $PSC > 0) {
        ...
        if ($PSC > 0) {
            show_option(33, 'Formations PSC1 par an selon le public');
        }
        show_option(34, 'Formations de secourisme par an');
    }
    if ($PAE > 0) {
        show_option(35, 'Formations de moniteur de secourisme par an');
    }
    ...
    if ($grades) {
        show_option(65, 'Répartition des adhérents par grade');
    }
    show_option(66, 'Ancienneté du personnel');
} else {
    echo "<OPTGROUP  label='Personnel'>";
    ...
    if ($grades) {
        show_option(65, 'Répartition du personnel par grade');
    }
    show_option(66, 'Ancienneté du personnel');
    show_option(77, "Durée moyenne d'engagement du personnel");
}
...
if (get_children("$filter") != '') {
    $noSub = [0, 9, 11, 31, 50, 51, 52, 53, 61];
...
// ===============================
$choixTypeEvt = [1, 4, 11, 31, 50, 72, 74];
...
// choix année
// ===============================
$noYearReports = [0, 6, 7, 8, 19, 23, 24, 25, 26, 28, 29, 30, 33, 34, 35, 37, 38, 40, 41, 50, 51, 52, 53, 55, 56, 57, 63, 64, 65,
...
// choix dates
// ===============================
$withDates = [51, 52, 53, 55, 56, 57, 72, 74];
...
switch ($report) {
    case 1:  print repo_events_by_month($filter, $subsections, $type, $year, $canceled = 0);
        break;
    case 2:  print repo_events_type($filter, $subsections, $type, $year);
        break;
    case 11: print repo_events_section($filter, $type, $year, $day = '', $competence = '');
        break;
    case 3:  print repo_dps_pic($filter, $subsections, $year, $type = 'DPS', $renfort = 0);
        break;
    case 12: print repo_dps_pic($filter, $subsections, $year, $type = 'GAR', $renfort = 1);
        break;
    case 13: print repo_dps_pic($filter, $subsections, $year, $type = 'MAR', $renfort = 1);
        break;
    case 4:  print repo_cancelled($filter, $subsections, $year, $type);
        break;
    case 5:  print repo_ca($filter, $subsections, $type, $year);
        break;
    case 6:  print repo_pse($filter, $subsections);
        break;
    case 7:  print repo_competences($filter, $subsections, $equipe);
        break;
    case 8:  print repo_pyramide_ages($filter, $subsections);
        break;
    case 9:  print repo_perso_dps($filter, $subsections, $year);
        break;
    case 14: print repo_formations($filter, $subsections, $year, $type, $competence = 'ALL', $tf = 'ALL');
        break;
    case 15: print repo_formations($filter, $subsections, $year, $type, $competence = 'ALL', $tf = 'I');
        break;
    case 16: print repo_formations($filter, $subsections, $year, $type, $competence = 'ALL', $tf = 'C');
        break;
    case 17: print repo_formations($filter, $subsections, $year, $type, $competence = 'ALL', $tf = 'R');
        break;
    case 18: print repo_personnel_formation($filter, $subsections, $year, $type = 'FOR');
        break;
    case 19: print repo_type_members($filter, $subsections);
        break;
    case 20: print repo_flux_members($filter, $subsections, $year, $period = 'month', $cat_personnel = 'interne');
        break;
    case 21: print repo_dps_type($filter, $subsections, $year);
        break;
    case 22: print repo_dps_type_month($filter, $subsections, $year);
        break;
    case 23: print repo_browser($filter, $subsections, 'os');
        break;
    case 24: print repo_browser($filter, $subsections, 'browser');
        break;
    case 25: print repo_age_vehicules($filter, $subsections);
        break;
    case 26: print repo_flux_members($filter, $subsections, $year, $period = 'year', $cat_personnel = 'interne');
        break;
    case 27: print repo_flux_members($filter, $subsections, $year, $period = 'month', $cat_personnel = 'ext');
        break;
    case 28: print repo_flux_members($filter, $subsections, $year, $period = 'year', $cat_personnel = 'ext');
        break;
    case 29: print repo_diplomes($filter, $subsections);
        break;
    case 30: print repo_dps_year($filter, $subsections, $renfort = 0);
        break;
    case 31: print repo_taux_participation($filter, $type, $year);
        break;
    case 32: print repo_dps_pic($filter, $subsections, $year, $type = 'NAUT', $renfort = 1);
        break;
    case 33: print repo_formation_par_public($filter, $subsections);
        break;
    case 34: print repo_formation_par_an($filter, $subsections, $what = 'secouriste');
        break;
    case 35: print repo_formation_par_an($filter, $subsections, $what = 'moniteur');
        break;
    case 36: print repo_events_by_month($filter, $subsections, $type, $year, $canceled = 1);
        break;
    case 37: print repo_sexe($filter, $subsections);
        break;
    case 38: print repo_dps_year($filter, $subsections, $renfort = 1);
        break;
    case 39: print repo_dps_pic($filter, $subsections, $year, $type = 'DPS', $renfort = 1);
        break;
    case 40: print repo_members_year($filter, $subsections, $cat_personnel = 'INT');
        break;
    case 41: print repo_members_year($filter, $subsections, $cat_personnel = 'SAL');
        break;
    case 42: print repo_members_year($filter, $subsections, $cat_personnel = 'EXT');
        break;
    case 50: print repo_events_section($filter, $type, $year, $day = 1, $competence = '');
        break;
    case 51: print repo_stats($filter, $dtdb, $dtfn, '');
        break;
    case 52: print repo_stats($filter, $dtdb, $dtfn, 'C_SEC');
        break;
    case 53: print repo_stats($filter, $dtdb, $dtfn, 'C_OPE');
        break;
    case 55: print repo_nb_events($filter, $dtdb, $dtfn, 'ALL');
        break;
    case 56: print repo_nb_events($filter, $dtdb, $dtfn, 'C_SEC');
        break;
    case 57: print repo_nb_events($filter, $dtdb, $dtfn, 'C_OPE');
        break;
    case 60: print repo_formations($filter, $subsections, $year, $type, $competence = 'GQS', $tf = 'ALL');
        break;
    case 61: print repo_events_section($filter, 'FOR', $year, $day = '', $competence = 'GQS');
        break;
    case 62: print repo_age_stagiaires($filter, $subsections, $year, $competence = 'GQS');
        break;
    case 63: print repo_specific_event($filter, $subsections, $search = 'attentat');
        break;
    case 64: print repo_specific_event($filter, $subsections, $search = 'inondation');
        break;
    case 65: print repo_grade($filter, $subsections);
        break;
    case 66: print repo_anciennete($filter, $subsections);
        break;
    case 67: print repo_connexion_heure_journee($filter, $subsections);
        break;
    case 68: print repo_connexion_jour_semaine($filter, $subsections);
        break;
    case 69: print repo_connexion_jour($filter,$subsections,'connexions');
        break;
    case 70: print repo_connexion_jour($filter,$subsections,'erreurs');
        break;
    case 71: print repo_connexion_du_jour($filter,$subsections);
        break;
    case 72: print repo_participations_par_jour($filter,$subsections,$dtdb,$dtfn,$type);
        break;
    case 73: print repo_connexion_du_jour($filter,$subsections,'erreurs');
        break;
    case 74: print repo_evenements_par_jour($filter,$subsections,$dtdb,$dtfn,$type);
        break;
    case 77: print repo_duree_engagement($filter,$subsections);
        break;
    case 78: print repo_duree_engagement_par_age($filter,$subsections);
        break;
    case 79: print repo_nombre_personnes_par_mois($filter,$subsections,$year);
        break;
