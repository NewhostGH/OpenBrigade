...
if (isset($_GET['usage'])) {
    $usage = secure_input($dbc, $_GET['usage']);
} else {
    $usage = 'ALL';
}
if (isset($_GET['like'])) {
...
if ($usage == 'ALL') {
    ...
    $cmt = "Ajout d'un nouveau ".$row['CM_DESCRIPTION'];
}
$picture = $row['PICTURE'];
...
if ($usage == 'ALL') {
    echo "<option value='ALL'>Choisissez une catégorie</option>";
}
...
if ($usage == 'ALL') {
    ...
    echo "<tr>
            ...
            <td  align=left>
         <select name='TM_ID' class='form-control form-control-sm' data-style='btn-default'>";
    ...
    echo "<tr>
            ...
            <td align=left>";
    echo "<select id='groupe' name='groupe' class='form-control form-control-sm' data-style='btn-default'>";
    ...
    echo "<tr>
            ...
            <td align=left><input type='text' name='MA_COMMENT' size='25' class='form-control form-control-sm' value=\"$_MA_COMMENT\">";
    echo ' </td>
      </tr>';
    ...
    echo "<tr>
            <td><b>Lieu de stockage</b></td>
            <td align=left><input type='text' name='MA_LIEU_STOCKAGE' size='25' class='form-control form-control-sm' value=\"$_MA_LIEU_STOCKAGE\">";
    echo ' </td>
      </tr>';
    ...
    echo "<center><p><input type='submit' class='btn btn-success' value='Sauvegarder'></form>";
    if ($from == 'personnel' and $_AFFECTED_TO > 0) {
        echo " <input type='button' class='btn btn-default' value='Annuler' name='annuler' onclick=\"redirect3('upd_personnel.php?from=tenues&pid=".$_AFFECTED_TO."');\"></div>";
    } else {
        echo " <input type='button'class='btn btn-secondary'  value='Retour' name='annuler' onclick='redirect2();'></div>";
    }
}
writefoot();
?>
