...
$columns_title = ['Catégorie', 'Type', 'Stock', 'Min.', 'Conditionnement', 'Section',
...
if ($type_conso != 'ALL') {
    $query1 .= " and (c.TC_ID='".$type_conso."' or tc.CC_CODE='".$type_conso."')";
}
...
while (custom_fetch_array($result1)) {
    ...
    $columns_data = [$CC_NAME, $TC_DESCRIPTION, $C_NOMBRE, $C_MINIMUM, $conditionnement,
