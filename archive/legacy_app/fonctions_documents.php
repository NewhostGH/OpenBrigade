...
function get_smaller_icon($type, $padding = 1)
{
    ...
    if ($type == 'pdf') {
        ...
        $c = 'file-archive';
        $l = 'orange';
    } elseif ($type == 'jpg' or $type == 'jpeg' or $type == 'png') {
        $c = 'file-image';
        $l = 'purple';
    ...
    if (is_dir($mypath)) {
        ...
        while ($file = readdir($dir)) {
            ...
            if ($file != '.' and $file != '..' and (file_extension($file) != 'db')) {
                ...
                if ($row['F_ID'] == 120) {
                    if (is_inscrit($_SESSION['id'], $evenement)) {
                        $visible = true;
                    }
                }
                ...
                if ($nb > 0) {
                    ...
                    if ($age < 1440) {
                        $new = "<i class='fa fa-star' style='color:yellow;' title=\"Ce document a été ajouté il y a moins de 24 heures\" ></i>";
                    } else {
                        $new = '';
                    }
                } else {
                ...
                if ($author != '') {
                    $author = '<a href=upd_personnel.php?tab=1&pompier='.$author.'>'.
                ...
                if ($document_security == 0) {
                    ...
                    $img = "<span class='btn btn-default btn-action' href=#><i class='fa fa-lock' style='color:#f64e60;' title=\"".$securitylabel.'"></i></span>';
                } else {
                    $img = "<span class='btn btn-default btn-action' href=#><i class='fa fa-unlock' style='color:#1bc5bd;' title=\"".$securitylabel.'"></i></span>';
                }
