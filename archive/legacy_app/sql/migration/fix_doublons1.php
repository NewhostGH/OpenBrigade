...
// REPLACE(REPLACE(P_PRENOM,'è','e'),'é','e')
...
while (custom_fetch_array($result0)) {
    ...
    if ($nbactif == 1) {
        ...
        if ($nbancien == 1) {
            ...
            $query2 = 'select P_ID from pompier where ID_API is null and P_ID <> '.$P_ID.'
            and P_NOM="'.$P_NOM."\" and REPLACE(REPLACE(P_PRENOM,'è','e'),'é','e')=\"".$P_PRENOM.'" and P_BIRTHDATE is null';
            $result2 = mysqli_query($dbc, $query2);
        ...
        echo ' mapping impossible (plusieurs fiches actifs) ...';
    }
}
...
// delete anciens créés le 30-09-2020
echo '<p>============STEP 2 =================================';
$query0 = "select P_ID, P_NOM, REPLACE(REPLACE(P_PRENOM,'è','e'),'é','e') P_PRENOM, P_BIRTHDATE, P_SECTION, P_LICENCE, P_LICENCE_DATE, ID_API from pompier
