...
$columns_title = ['Nom', 'Absence', 'Début', 'Fin', 'Nombre Jours',
...
if ($order == 'I_DEBUT' or $order == 'I_FIN' or $order == 'I_COMMENT') {
    $query1 .= ' desc';
}
...
while ($row = @mysqli_fetch_array($result1)) {
    ...
    $columns_data = [strtoupper($P_NOM).' '.ucfirst($P_PRENOM), $TI_LIBELLE, $I_DEBUT, $I_FIN, $abs,
