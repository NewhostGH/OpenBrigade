...
if (isset($_POST['package'])) {
    $package_name = secure_input($dbc, $_POST['package']);
} else {
    $package_name = '';
}
...
if (isset($_POST['patch_version'])) {
    $patch_version = secure_input($dbc, $_POST['patch_version']);
} else {
    $patch_version = '';
}
$error = 0;
...
if ($reason == 'unzip' and $package_name == '') {
    return;
}
