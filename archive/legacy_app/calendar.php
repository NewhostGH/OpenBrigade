...
if (isset($_GET['pompier']) and check_rights($id, 56)) {
...
if ($onlyTable) {
    ...
    while (custom_fetch_array($result)) {
        ...
        if ($EP_ASTREINTE == 1) {
            $img2 = "<td><i class=\'fa fa-exclamation-triangle\' style=\'color:orange;\' title=\'Astreinte (garde non remuneree)\'></i></td>";
        } else {
            $img2 = '';
        }
        ...
        if ($nbsections == 0) {
            $desc .= ' organisé par '.$S_DESCRIPTION;
        }
