...
if (isset($_POST['categorie'])) {
    $new_categorie = secure_input($dbc, $_POST['categorie']);
} else {
    $new_categorie = '';
}
...
if (isset($_POST['icon'])) {
    $G_ICON = secure_input($dbc, $_POST['icon']);
} else {
    $G_ICON = 'images/user-specific/DEFAULT.png';
}
if (isset($_POST['usage'])) {
    $codeCat = secure_input($dbc, $_POST['usage']);
} else {
    $codeCat = '';
}
if (isset($_POST['oldCat'])) {
    $oldCat = secure_input($dbc, $_POST['oldCat']);
} else {
    $oldCat = '';
}
if (isset($_GET['codeGrade'])) {
    $codeGrade = secure_input($dbc, $_GET['codeGrade']);
} else {
    $codeGrade = '';
}
