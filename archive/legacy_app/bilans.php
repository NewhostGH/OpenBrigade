...
function write_link($num, $title)
{
    ...
    $bgImage = '';
    $description = '';
    if ($title == 'Généralités') {
        $bgColor = '#1B283F';
        $buttonColor = '#ffa800';
        $btnStyle = 'btn-generalites';
        $bgImage = './images/generalites.png';
        $description = 'Retrouvez le bilan annuels complet du personnel et des moyens (véhicules, matériel et consommables).';
    } elseif ($title == 'Activités opérationnelles') {
        $bgColor = '#8950fc';
        $buttonColor = '#1bc5bd';
        $btnStyle = 'btn-activites';
        $bgImage = './images/activites.png';
        $description = "Bilan annuel de l'ensemble des activités opérationnelle de votre structure.";
    } elseif ($title == 'Formations') {
        $bgColor = '#9be0df';
        $buttonColor = '#f64e60';
        $btnStyle = 'btn-formation';
        $bgImage = './images/formation.png';
        $description = "Liste de toutes les formations prodiguées durant l'année.";
    }
