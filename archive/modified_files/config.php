...
foreach ($__legacy_scope_vars as $__legacy_key => $__legacy_value) {
    if ($__legacy_key === 'GLOBALS') continue;
    if (strpos($__legacy_key, '__legacy_') === 0) continue;
    if ($__legacy_key === '_SERVER' || $__legacy_key === '_GET' || $__legacy_key === '_POST' || $__legacy_key === '_COOKIE' || $__legacy_key === '_SESSION' || $__legacy_key === '_FILES' || $__legacy_key === '_ENV' || $__legacy_key === '_REQUEST') continue;
