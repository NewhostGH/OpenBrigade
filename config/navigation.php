    ...
    'top' => [
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'admin.charter',         'label' => 'Charte',          'url' => '/admin/charter',         'icon' => 'file-contract',  'permission' => 14],
                ['key' => 'admin.monitoring',      'label' => 'Monitoring',      'url' => '/admin/monitoring',      'icon' => 'history',        'permission' => 49],
                ['key' => 'account.connected-users', 'label' => 'Utilisateurs connectés', 'url' => '/admin/connected-users',    'icon' => 'users',        'permission' => 20],
