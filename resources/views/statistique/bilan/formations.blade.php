...
@section('content')
    ...
    @include('statistique.bilan._tabs', ['activeTab' => 'formations'])
...
@push('scripts')
    <script>
        ...
        window.__BILAN_PDF_DATA__ = {
            ...
            formationsList: @json($formationsList->map(fn($f) => ['label' => $f->label ?: null, 'type' => $f->type ?: null, 'lieu' => $f->lieu ?: null, 'date' => $f->date, 'duree_h' => $f->duree_h ?: null, 'nb' => $f->nb_participants])->values()),
        };
    </script>
