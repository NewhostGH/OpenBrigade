...
<div class="ob-hab-matrix" data-hab-matrix>
    ...
    {{-- Person search + scope --}}
    <form method="GET" action="{{ route('admin.habilitations') }}" class="ob-hab-create mb-2">
    ...
    @if ($people->isNotEmpty())
        <div class="ob-hab-people mb-3">
            @foreach ($people as $p)
                <a href="{{ route('admin.habilitations', ['tab' => 'overrides', 'person' => $p->P_ID, 'section' => $scopeId ?: null]) }}"
                            ...
                            <tr class="ob-hab-feat">
                                ...
                                <td class="ob-hab-cell">
                                    @include('admin.habilitations.partials.effect-cell', [
                                        'action'  => route('admin.habilitations.user.set'),
