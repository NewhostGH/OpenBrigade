...
<div class="mx-3 mt-3">
    <div class="row g-3">
        ...
        $sections = [
            ...
            ['route' => 'admin.references.contact-type',   'icon' => 'address-card',   'label' => 'Identifiants de contact','count' => $counts['contact_type'],     'desc' => 'Skype, WhatsApp, Zello…'],
            ['route' => 'admin.references.competence-hierarchy','icon' => 'stream',     'label' => 'Hiérarchies de compétences','count' => $counts['poste_hierarchie'], 'desc' => 'Niveaux, prolongation et recyclage'],
