...
<div class="mx-3 mt-3">
    ...
    <div class="ob-widget-card mb-3">
        ...
        <div class="p-3">
            <form method="POST" action="{{ route('admin.parametrage.type-materiel.store') }}">
                @csrf
                @if($errors->any())
                ...
                @forelse($items as $item)
                    ...
                    <tr>
                        ...
                        <td class="align-middle" style="font-size:var(--font-size-sm);">
                            <form method="POST" action="{{ route('admin.parametrage.type-materiel.update', $item->TM_ID) }}"
                        ...
                        <td class="align-middle text-end">
                            <form method="POST" action="{{ route('admin.parametrage.type-materiel.destroy', $item->TM_ID) }}"
