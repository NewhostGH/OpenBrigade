...
<div class="mx-3 mt-3">
    ...
    <div class="ob-widget-card mb-3">
        ...
        <div class="p-3">
            <form method="POST" action="{{ route('admin.parametrage.type-evenement.store') }}">
                @csrf
                @if($errors->any())
                ...
                @forelse($items as $item)
                    <tr>
                        ...
                        <td class="align-middle" style="font-size:var(--font-size-sm);">
                            <form method="POST" action="{{ route('admin.parametrage.type-evenement.update', $item->TE_CODE) }}"
                        ...
                        <td class="align-middle text-end">
                            <form method="POST" action="{{ route('admin.parametrage.type-evenement.destroy', $item->TE_CODE) }}"
