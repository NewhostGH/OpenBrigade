...
<div class="mx-3 mt-3">
    ...
    <div class="ob-widget-card mb-3">
        <div class="ob-widget-card-header">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('organisation.sections.edit', $section->S_ID) }}" class="btn btn-sm btn-outline-secondary">
        ...
        @foreach ($tabs as $key => $tab)
            <li class="nav-item">
                <a class="nav-link{{ $activeTab === $key ? ' active' : '' }}"
                   href="{{ route('organisation.sections.show', [$section->S_ID, 'tab' => $key]) }}">
                    ...
                    <div class="ob-widget-card-body">
                        <dl class="ob-info-grid mb-0">
                            ...
                            <div class="ob-info-item">
                                ...
                                <dd>
                                    @if ($section->parent)
                                        <a href="{{ route('organisation.sections.show', $section->parent->S_ID) }}">
    ...
    @elseif ($activeTab === 'personalisation')
        ...
        <form method="POST"
              action="{{ route('organisation.sections.personalisation', $section->S_ID) }}"
    ...
    @elseif ($activeTab === 'cotisation')
        ...
        <form method="POST" action="{{ route('organisation.sections.rib', $section->S_ID) }}">
            @csrf @method('PATCH')
