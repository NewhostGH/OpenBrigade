...
<div class="ob-widget-card">
    ...
    <div class="ob-widget-card-body">
        @if ($hasTrainee)
            ...
            @foreach ($training['asTrainee'] as $row)
                ...
                <div class="ob-dash-training-row">
                    <span class="ob-dash-training-code">{{ $row->PH_CODE ?: 'Autres' }}</span>
            ...
            <div class="ob-dash-training-row" style="font-weight:600;">
                <span class="ob-dash-training-code">TOTAL</span>
        ...
        @if ($hasTrainer)
            ...
            @endforeach
            <div class="ob-dash-training-row" style="font-weight:600;">
                <span class="ob-dash-training-code">TOTAL formateur</span>
                <span>{{ sprintf('%02d:%02d', floor($totalMins/60), $totalMins%60) }} h</span>
            </div>
        @endif
    </div>
