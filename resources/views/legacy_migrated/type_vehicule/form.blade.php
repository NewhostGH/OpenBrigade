        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ ($item && $itemKey) ? route('legacy_migrated.type_vehicule.update', $itemKey) : route('legacy_migrated.type_vehicule.store') }}">
                        @csrf
                        @if($item)
                            @method('PUT')
                        @endif
        ...
        <div class="mb-3">
            ...
            @enderror
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('legacy_migrated.type_vehicule.index') }}" class="btn btn-outline-secondary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
