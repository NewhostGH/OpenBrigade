        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ ($item && $itemKey) ? route('legacy_migrated.ins_poste.update', $itemKey) : route('legacy_migrated.ins_poste.store') }}">
                        @csrf
                        @if($item)
                            @method('PUT')
                        @endif
...
<input type="hidden" id="PS_ORDER" name="PS_ORDER" value="{{ old('PS_ORDER', $item?->PS_ORDER) }}">
        ...
        <div class="mb-3">
            ...
            @enderror
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('legacy_migrated.ins_poste.index') }}" class="btn btn-outline-secondary">Back</a>
                        </div>
                    </form>
                </div>
            </div>
