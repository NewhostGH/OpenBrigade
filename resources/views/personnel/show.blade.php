            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col">
                    <dl class="mb-0" style="display:grid; grid-template-columns:auto 1fr; gap:5px 16px;
                        ...
                        <dd class="mb-0">{{ $personnel->section?->S_CODE ?: __('common.empty_value') }}
                    ...
                    <div class="ob-widget-card-body">
                        <dl class="ob-info-grid mb-0">
                            ...
                            <div class="ob-info-item">
                                ...
                                <dd>{{ $personnel->P_PHONE ?: __('common.empty_value') }}</dd>
                            </div>
                            <div class="ob-info-item">
                                <dt>{{ __('personnel.field_portable') }}</dt>
                                <dd>{{ $personnel->P_PHONE2 ?: __('common.empty_value') }}</dd>
                            </div>
                            <div class="ob-info-item">
                    ...
                    <div class="ob-widget-card-body">
                        <dl class="ob-info-grid mb-0">
                            <div class="ob-info-item">
                                ...
                                <dd>
                                    {{ $personnel->P_BIRTHDATE?->format('d/m/Y') ?? __('common.empty_value') }}
                            ...
                            <div class="ob-info-item">
                                ...
                                <dd>
                                    {{ $personnel->P_BIRTHPLACE ?: __('common.empty_value') }}
                            ...
                            <div class="ob-info-item">
                                ...
                                <dd>{{ $personnel->P_NOM_NAISSANCE ?: __('common.empty_value') }}</dd>
                            </div>
                            <div class="ob-info-item">
                                <dt>{{ __('personnel.field_date_fin') }}</dt>
                                <dd>{{ $personnel->P_FIN?->format('d/m/Y') ?? __('common.empty_value') }}</dd>
                            </div>
                            <div class="ob-info-item">
                                <dt>{{ __('personnel.field_profession') }}</dt>
                                <dd>{{ $personnel->P_PROFESSION ?: __('common.empty_value') }}</dd>
                            </div>
                    ...
                    <div class="ob-widget-card-body">
                        <dl class="ob-info-grid mb-0">
                            <div class="ob-info-item">
                                ...
                                <dd>{{ trim($personnel->P_RELATION_PRENOM . ' ' . $personnel->P_RELATION_NOM) ?: __('common.empty_value') }}</dd>
                            </div>
                            <div class="ob-info-item">
                                <dt>{{ __('personnel.field_telephone') }}</dt>
                                <dd>{{ $personnel->P_RELATION_PHONE ?: __('common.empty_value') }}</dd>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($personnel->qualifications->sortBy('poste.TYPE') as $qual)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $qual->Q_VAL ?: __('common.empty_value') }}</td>
                                            <td>
                                                ...
                                                @else <span class="text-muted">{{ __('common.empty_value') }}</span>
                                                @endif
                                            </td>
                                    ...
                                    @foreach($formations as $pf)
                                        <tr>
                                            <td class="ps-3" style="white-space:nowrap">
                                                {{ $pf->PF_DATE ? \Carbon\Carbon::parse($pf->PF_DATE)->format('d/m/Y') : __('common.empty_value') }}
                                            </td>
                                            <td>
                                            ...
                                            <td>{{ $pf->TF_LIBELLE }}</td>
                                            <td>{{ $pf->PF_DIPLOME ?: __('common.empty_value') }}</td>
                                            <td>{{ $pf->PF_LIEU ?: __('common.empty_value') }}</td>
                                            <td>{{ $pf->PF_RESPONSABLE ?: __('common.empty_value') }}</td>
                                            <td>{{ $pf->PF_COMMENT ?: __('common.empty_value') }}</td>
                                            @if(auth()->user()->hasPermission(4))
                                ...
                                <tbody>
                                    @foreach ($cotisations as $cotis)
                                        <tr>
                                            ...
                                            <td>{{ $cotis->PERIODE_CODE ?: __('common.empty_value') }}</td>
                                            <td>{{ $cotis->PC_DATE?->format('d/m/Y') ?? __('common.empty_value') }}</td>
                                            ...
                                            <td>{{ $cotis->typePaiement?->TP_DESCRIPTION ?? __('common.empty_value') }}</td>
                                    ...
                                    @foreach ($participation as $ep)
                                        ...
                                        <tr>
                                            ...
                                            <td style="color:var(--text-muted-soft)">
                                                {{ $ep->E_DATE_DEBUT ? \Carbon\Carbon::parse($ep->E_DATE_DEBUT)->format('d/m/Y') : __('common.empty_value') }}
                                            </td>
                                            <td class="text-end" style="color:var(--text-muted-soft)">
                                                {{ $ep->EP_DUREE ? number_format((float) $ep->EP_DUREE, 1) . ' h' : __('common.empty_value') }}
                                            </td>
                                            <td class="text-end" style="color:var(--text-muted-soft)">
                                                {{ $ep->EP_KM ? $ep->EP_KM . ' km' : __('common.empty_value') }}
                                            </td>
                            ...
                            <table class="ob-table ob-table-sm w-100 mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $t->MA_MODELE }}</td>
                                        <td>{{ $t->MA_ANNEE }}</td>
                                        <td>{{ $t->TV_NAME ?? __('common.empty_value') }}</td>
                    ...
                    <div class="ob-widget-card-body">
                        @if ($gps && $gps->LAT && $gps->LNG)
                            <dl class="ob-info-grid mb-0">
                                ...
                                <div class="ob-info-item">
                                    <dt>{{ __('personnel.field_adresse') }}</dt>
                                    <dd>{{ $gps->ADDRESS ?: __('common.empty_value') }}</dd>
                                </div>
                                <div class="ob-info-item">
                                    <dt>{{ __('personnel.field_derniere_maj') }}</dt>
                                    <dd>{{ $gps->DATE_LOC ? date('d/m/Y H:i', strtotime($gps->DATE_LOC)) : __('common.empty_value') }}</dd>
                                </div>
                            </dl>
                        @else
