        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6"><strong>Naissance:</strong> {{ $personnel->P_BIRTHDATE?->format('d/m/Y') ?: '-' }}</div>
                    <div class="col-md-6"><strong>Engagement:</strong> {{ $personnel->P_DATE_ENGAGEMENT?->format('d/m/Y') ?: '-' }}</div>
                    ...
                    <div class="col-md-6"><strong>Ville:</strong> {{ $personnel->P_ZIP_CODE }} {{ $personnel->P_CITY }}</div>
                </div>
