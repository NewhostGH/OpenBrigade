...
Route::middleware('auth')->prefix('legacy')->group(function () {
    ...
    Route::match(['GET', 'POST'], 'company.php', [LegacyBridgeController::class, 'show'])->middleware('permission:29')->name('legacy_bridge.company');
    ...
    Route::match(['GET', 'POST'], 'evenement_detail.php', [LegacyBridgeController::class, 'show'])->middleware('permission:41')->name('legacy_bridge.evenement_detail');
    ...
    Route::match(['GET', 'POST'], 'evenement_display.php', [LegacyBridgeController::class, 'show'])->middleware('permission:0')->name('legacy_bridge.evenement_display');
    ...
    Route::match(['GET', 'POST'], 'evenements.php', [LegacyBridgeController::class, 'show'])->name('legacy_bridge.evenements');
    ...
    Route::match(['GET', 'POST'], 'feuille_garde.php', [LegacyBridgeController::class, 'show'])->middleware('permission:61')->name('legacy_bridge.feuille_garde');
    ...
    Route::match(['GET', 'POST'], 'organigramme.php', [LegacyBridgeController::class, 'show'])->middleware('permission:44')->name('legacy_bridge.organigramme');
    ...
    Route::match(['GET', 'POST'], 'repo_events.php', [LegacyBridgeController::class, 'show'])->middleware('permission:27')->name('legacy_bridge.repo_events');
    ...
    Route::match(['GET', 'POST'], 'section.php', [LegacyBridgeController::class, 'show'])->middleware('permission:0')->name('legacy_bridge.section');
    ...
    Route::match(['GET', 'POST'], 'tableau_garde.php', [LegacyBridgeController::class, 'show'])->middleware('permission:0')->name('legacy_bridge.tableau_garde');
    ...
    Route::match(['GET', 'POST'], 'trombinoscope.php', [LegacyBridgeController::class, 'show'])->middleware('permission:0')->name('legacy_bridge.trombinoscope');
