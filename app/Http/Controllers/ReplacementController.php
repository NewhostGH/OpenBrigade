...
class ReplacementController extends Controller
{
    ...
    private function remplacementColumns(): array
    {
        return [
            ...
            ['key' => 'date', 'label' => 'Date', 'type' => 'html', 'value' => fn ($r) => $r->EH_DATE_DEBUT ? Carbon::parse($r->EH_DATE_DEBUT)->locale('fr')->isoFormat('ddd D MMM YYYY') : __('common.empty_value'), 'mobile' => false, 'exportable' => true, 'exportValue' => fn ($r) => $r->EH_DATE_DEBUT ? Carbon::parse($r->EH_DATE_DEBUT)->format('d/m/Y') : ''],
