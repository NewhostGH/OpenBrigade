...
/**
 * Legacy migration source: ins_type_materiel.php
 * Legacy pattern: create
 * Legacy permission id: 18
 * This file stems from a legacy migration and requires functional verification.
 */
class InsTypeMaterielController extends Controller
{
    public function create()
    {
        return view('legacy_migrated.ins_type_materiel.form', [
            'item' => null,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('legacy_migrated.ins_type_materiel.edit', $item->id)
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('legacy_migrated.ins_type_materiel.index')
