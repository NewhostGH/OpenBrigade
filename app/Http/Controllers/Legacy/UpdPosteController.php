...
/**
 * Legacy migration source: upd_poste.php
 * Legacy pattern: edit
 * Legacy permission id: 18
 * This file stems from a legacy migration and requires functional verification.
 */
class UpdPosteController extends Controller
{
    public function create()
    {
        return view('legacy_migrated.upd_poste.form', [
            'item' => null,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('legacy_migrated.upd_poste.edit', $item->id)
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('legacy_migrated.upd_poste.index')
